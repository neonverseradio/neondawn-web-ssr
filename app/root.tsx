  ...
  return (
    <header className="neon-header">
      ...
      <p className="broadcast">
        Offline Well be back tomorrow 6am est
      </p>

      <h3>
        — the grid is powering up for the launch —
      </h3>
...
export const meta = () => {
  return [
    ...
    {
      property: "og:url",
      content: "https://neonverseradio.com"
    },
